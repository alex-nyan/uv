...
"#,
    ...
    fn materializes_multiple_concrete_roots_with_shared_dependencies() {
        ...
        insta::assert_debug_snapshot!(graph_snapshot(&resolution));
    }
    ...
    fn materializes_the_selected_universal_lock_fork() {
        ...
        insta::assert_debug_snapshot!("darwin", graph_snapshot(&darwin));
        insta::assert_debug_snapshot!("linux", graph_snapshot(&linux));
        insta::assert_debug_snapshot!("concrete_fork", graph_snapshot(&concrete_fork));
    }
